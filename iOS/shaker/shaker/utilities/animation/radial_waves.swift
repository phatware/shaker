...
//  shaker
//
//  Created by Stan Miasnikov on 1/6/23.
//
...
struct RadialWavesView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Circle()
                .frame(width: 12.5, height: 12.5, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
...
struct AnimatedRectView_Previews: PreviewProvider {
